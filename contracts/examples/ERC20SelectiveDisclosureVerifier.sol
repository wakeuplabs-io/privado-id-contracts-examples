...
contract ERC20SelectiveDisclosureVerifier is ERC20Upgradeable, EmbeddedZKPVerifier {
    ...
    /// @custom:storage-location erc7201:opid.storage.ERC20SelectiveDisclosureVerifier
    ...
    // keccak256(abi.encode(uint256(keccak256("opid.storage.ERC20SelectiveDisclosureVerifier")) - 1)) & ~bytes32(uint256(0xff))
